        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="logo-area">
                        <p style="color:white;font-size:1.25em;font-weight:bold"> <i style="color:white;font-size:1em;font-weight:bold" class="notika-icon notika-edit"></i> &nbsp;Voting Management System</p>
                    </div>
                </div>
