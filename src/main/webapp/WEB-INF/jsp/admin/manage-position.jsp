...
<body>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="form-example-wrap mg-t-30">
						<form id="addPositionForm"
							action="${pageContext.request.contextPath}/position/new"
							method="POST">
								...
								<tbody>
									<c:forEach items="${positionList}" var="element"
										...
										<tr>
											...
											<td>
											   <a href="${pageContext.request.contextPath}/position/edit/${element.positionId}"
	...
	<form id="deletePositionForm" action="${pageContext.request.contextPath}/position/remove" method="POST">
